...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do sistema SmartAtendimento...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema SmartAtendimento...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar o SmartAtendimento...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Remoção da Instancia ${empresa_delete} realizado com sucesso ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear o SmartAtendimento...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Bloqueio da Instancia ${empresa_bloquear} realizado com sucesso ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o SmartAtendimento...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Desbloqueio da Instancia ${empresa_desbloquear} realizado com sucesso ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios do SmartAtendimento...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Alteração de dominio da Instancia ${empresa_dominio} realizado com sucesso ...${GRAY_LIGHT}"
  printf "\n\n"
